                      ...
                      : "text-gray-500 hover:text-gray-700"
                        ...
                        {activeTab === "birthdays" && (
                          <div className="space-y-4 py-6 px-6">
                            ...
                            <div className="pt-6 border-t border-gray-200">
                              <p className="text-sm leading-none text-gray-500 mb-6">Next seven days</p>
                        ...
                        {activeTab === "anniversary" && (
                            ...
                            <div className="">
                              ...
                              <p className="text-base font-bold text-center mt-4">No one is having work anniversary today</p>
                            </div>
                           ...
                           <div className="space-y-4 py-6 px-6">
                            <div className="">
                              <img className="m-auto" src={NewJoin} />
                               <p className="text-base font-bold text-center mt-4">No one join this week</p>
                            </div>
